...
public class UserProfileData {
    ...
    private String inputDaysOfWeek;

    public String getInputDaysOfWeek() {
        return inputDaysOfWeek;
    }

    public void setInputDaysOfWeek(String inputDaysOfWeek) {
        this.inputDaysOfWeek = inputDaysOfWeek;
    }
