...
public class NursesAdapter extends RecyclerView.Adapter<NursesAdapter.ViewHolder> {

    Activity activity;

    public NursesAdapter(Activity activity) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_nurses,parent,false);
