...
import com.weboconnect.nursify.screen.nurse.OfferedJobsActivityActivity;

public class OfferedAdapter extends RecyclerView.Adapter<OfferedAdapter.ViewHolder> {

    Activity activity;

    public OfferedAdapter(Activity activity) {
