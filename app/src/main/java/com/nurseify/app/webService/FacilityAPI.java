...
import com.nurseify.app.screen.facility.model.AddJobModel;
...
public interface FacilityAPI {
    ...
    Call<com.nurseify.app.screen.nurse.model.FacilityJobModel> call_facility_profile(@Part("facility_id") RequestBody facility_id);
