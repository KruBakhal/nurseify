...
import static com.nurseify.app.utils.Utils.patternAddress;
import static com.nurseify.app.utils.Utils.patternNumbers;
    ...
    private void click() {
        setup1Binding.imgBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (viewModel.isEditMode && viewModel.option_call == 2) {
                    getActivity().finish();
                } else
